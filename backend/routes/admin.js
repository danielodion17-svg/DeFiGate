...
router.get('/jobs/status', requireRole('admin'), admin.getJobsStatus);
router.post('/jobs/start', requireRole('admin'), admin.startScheduler);
router.post('/jobs/stop', requireRole('admin'), admin.stopScheduler);
router.post('/jobs/:jobName/start', requireRole('admin'), admin.startJob);
router.post('/jobs/:jobName/stop', requireRole('admin'), admin.stopJob);
router.post('/jobs/:jobName/run-once', requireRole('admin'), admin.runJobOnce);
